...
# ============================================================
from pyrocast_physics_V2_vectorized import PatchDirectionalConv2D
...
def run_benchmark():
    ...
    for H, W in spatial_sizes:
        ...
        # New PyroCast Convolution
        patch_size = 3
        dir_conv = PatchDirectionalConv2D(kernel_size=kernel_size, patch_size=patch_size, verbose=False)
