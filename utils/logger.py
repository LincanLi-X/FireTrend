...
except Exception:  # TensorBoard is optional for headless training/evaluation.
    SummaryWriter = None
...
class TensorboardLogger:
    ...
    def __init__(self, log_dir="./outputs/logs"):
        if SummaryWriter is None:
            raise ImportError("TensorBoard is not installed. Install tensorboard to use TensorboardLogger.")
